...
public class TestActivity extends AppCompatActivity {
    ...
    String tv1Holder, tv2Holder, tv3Holder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1.setText(clase_de_iluminacion);
        tv2.setText(tramo);
        tv3.setText(condicion_atmosferica);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String ServerResponse) {
                                ...
                                Toast.makeText(TestActivity.this, ServerResponse, Toast.LENGTH_LONG).show();
                            }
                        },
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError volleyError) {
                                ...
                                Toast.makeText(TestActivity.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                            }
                        }) {
                    @Override
    ...
    public void GetValueFromEditText(){
        ...
        tv1Holder = tv1.getText().toString().trim();
        tv2Holder = tv2.getText().toString().trim();
        tv3Holder = tv3.getText().toString().trim();
